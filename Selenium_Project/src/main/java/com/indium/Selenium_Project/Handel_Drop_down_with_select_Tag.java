...
public class Handel_Drop_down_with_select_Tag {
	...
	public static void main(String[] args) {
	   ...
	   */
	   ...
	   //select options from drop_down
	   
	  /* for(int i=0;i<options.size();i++)
	   {
		  String option=options.get(i).getText();
		  
				if(option.equals("Java") || option.equals("Python") ||option.equals("C#"))
			{
			   options.get(i).click();
			}
			*/
